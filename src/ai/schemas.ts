    ...
    actions: {
      ...
      items: {
        ...
        properties: {
          ...
          startAtLocal: { type: ["string", "null"], description: "Local wall-clock ISO datetime in timezone, without UTC conversion. User 18:00 Europe/Moscow means YYYY-MM-DDT18:00:00, never 15:00." },
          endAtLocal: { type: ["string", "null"], description: "Local wall-clock ISO datetime in timezone, without UTC conversion." },
          dueAtLocal: { type: ["string", "null"], description: "Local deadline ISO datetime in timezone, without UTC conversion." },
